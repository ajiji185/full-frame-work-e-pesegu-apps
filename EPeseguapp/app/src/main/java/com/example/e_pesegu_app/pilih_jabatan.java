...
public class pilih_jabatan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pilih_jabatan);

        kontrak_05=findViewById(R.id.button6);
        kontrak_29=findViewById(R.id.button8);
        kontrak_41=findViewById(R.id.button7);
    ...
    private void pilihjabatan_41(String kontrak_41) {
        Intent intent=new Intent(this, kemasKiniData.class);
